...
export default class UploadMultipleFilesDialog {
  ...
  show() {
    ...
    document.getElementById('mfu-new-tag')
    ...
    document.getElementById('uploadMultipleFilesPicker')
    ...
    document.getElementById('save-upload-dialog')
      .addEventListener('click', () => {
        this.onHide({
          files: document.getElementById('uploadMultipleFilesPicker').files,
