...
export default class EditMenuDialog {
  ...
  async show() {
    ...
    const content = html` <form class="cosmo-modal__container" id="edit-dialog-menu">
    ...
    document.getElementById('editMenuLogoPicker').addEventListener('click', async (e) => {
      e.preventDefault();
