          ...
          <div class="jinya-designer__content jinya-designer__content--theme">
            <div class="cosmo-tab cosmo-tab-control--theme">
              <div class="cosmo-tab__links">
                <a id="details-tab-link" data-type="tab" data-target="details-tab" class="cosmo-tab__link is--active">
                  ${localize({ key: 'design.themes.tabs.details' })}
                </a>
                <a id="configuration-tab-link" data-type="tab" data-target="configuration-tab" class="cosmo-tab__link">
                ...
                <a id="variables-tab-link" data-type="tab" data-target="variables-tab" class="cosmo-tab__link">
              ...
              <form class="cosmo-tab__content cosmo-tab-control__content--theme" style="display: none;" id="links-tab">
                <div class="cosmo-input__group"></div>
                <div class="cosmo-button__container jinya-sticky--bottom">
