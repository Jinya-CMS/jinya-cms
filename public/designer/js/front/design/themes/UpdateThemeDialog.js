      ...
      <div class="cosmo-modal">
        ...
        <div class="cosmo-modal__content">
          <div class="cosmo-input__group">
            <label for="updateThemeZip" class="cosmo-label"> ${localize({ key: 'design.themes.update.file' })} </label>
            <input accept="application/zip" class="cosmo-input" required type="file" id="updateThemeZip" />
          </div>
        </div>
        <div class="cosmo-modal__button-bar">
          <button class="cosmo-button" id="cancel-update">${localize({ key: 'design.themes.update.cancel' })}</button>
