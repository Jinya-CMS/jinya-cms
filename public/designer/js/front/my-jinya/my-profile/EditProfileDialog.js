...
export default class EditProfileDialog {
  ...
  async show() {
    ...
    container.innerHTML = html` <form class="cosmo-modal__container" id="edit-profile-dialog">
      <div class="cosmo-modal">
        <h1 class="cosmo-modal__title">${localize({ key: 'my_jinya.my_profile.edit.title' })}</h1>
        <div class="cosmo-modal__content">
          <div class="cosmo-input__group">
            <label for="artistName" class="cosmo-label">${localize({ key: 'my_jinya.my_profile.artist_name' })}</label>
            <input required value="${this.artist.artistName}" type="text" id="artistName" class="cosmo-input" />
            <label for="email" class="cosmo-label"> ${localize({ key: 'my_jinya.my_profile.email' })} </label>
            ...
            <label for="aboutMe" class="cosmo-label is--textarea">
