...
export default class EditTextItemDialog {
  /**
   * Shows the edit dialog
   * @param onHide {function({item: any, label: string, placeholder: string, helpText: string, isRequired: boolean, isSubject: boolean, spamFilter: string[]})}
   * @param id {number}
   * @param formId {number}
...
${this.newItem ? '' : this.spamFilter.join('\n')}</textarea
            ...
            <div class="cosmo-input__group is--checkbox">
              <input type="checkbox" id="editItemIsSubject" class="cosmo-checkbox" ${this.isSubject ? 'checked' : ''} />
              <label for="editItemIsSubject">
