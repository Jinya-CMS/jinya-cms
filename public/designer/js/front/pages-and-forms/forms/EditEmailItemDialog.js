...
export default class EditEmailItemDialog {
  /**
   * Shows the edit dialog
   * @param onHide {function({item: any, label: string, placeholder: string, helpText: string, isRequired: string, isFromAddress: boolean})}
   * @param id {number}
   * @param formId {number}
