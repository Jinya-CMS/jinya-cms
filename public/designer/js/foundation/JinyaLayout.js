...
export default class JinyaLayout extends JinyaDesignerLayout {
  ...
  async getTemplate() {
    ...
    return html` <div class="cosmo-menu is--top">
      ...
      ? html` <div class="cosmo-menu__row" data-stage="front">
                ...
                <a href="#back/artists/index" class="cosmo-menu__item"> ${localize({ key: 'artists.menu.title' })} </a>
              </div>
      ...
      <div class="cosmo-menu">
        ...
        <nav class="cosmo-menu__collection" data-stage="front">
          <div class="cosmo-menu__row is--main" data-stage="front">
            ...
            <a href="#front/my-jinya/my-profile" class="cosmo-menu__item" data-section="my-jinya" data-stage="front">
              ${localize({ key: 'my_jinya.menu.title' })}
            </a>
          </div>
          <div class="cosmo-menu__row is--main" data-stage="back">
            <a href="#back/maintenance/updates" class="cosmo-menu__item" data-stage="back" data-section="maintenance">
              ${localize({ key: 'maintenance.menu.title' })}
            </a>
            <a href="#back/database/mysql-info" class="cosmo-menu__item" data-stage="back" data-section="database">
              ${localize({ key: 'database.menu.title' })}
            </a>
          ...
          <div class="cosmo-menu__row is--sub">
            ...
            <a
              href="#front/statistics/database"
              data-section="statistics"
              data-stage="front"
              hidden
              data-page="database"
            ...
            <a
              href="#front/pages-and-forms/segment-pages"
              data-section="pages-and-forms"
              data-stage="front"
              hidden
            ...
            <a
              href="#front/pages-and-forms/forms"
              data-section="pages-and-forms"
              data-stage="front"
              hidden
              data-page="forms"
            ...
            <a
              href="#front/blog/posts-overview"
              data-section="blog"
              data-stage="front"
              hidden
            ...
            <a
              href="#front/my-jinya/active-sessions"
              data-section="my-jinya"
              data-stage="front"
              hidden
            ...
            <a
              href="#front/my-jinya/active-devices"
              data-section="my-jinya"
              data-stage="front"
              hidden
            ...
            <a
              href="#back/maintenance/environment"
              data-section="maintenance"
              data-stage="back"
              hidden
            ...
            <a
              href="#back/maintenance/php-info"
              data-section="maintenance"
              data-stage="back"
              hidden
              data-page="php-info"
      ...
      <div class="cosmo-page__body">%%%child%%%</div>
  ...
  bumpUploadCounter() {
    ...
    if (this.filesUploaded === this.filesToUpload) {
      document.getElementById('file-upload-progress-top-label').innerText = localize({
        key: 'bottom_bar.upload_title.uploaded',
      });
    } else {
      document.getElementById('file-upload-progress-top-label').innerText = localize({
        key: 'bottom_bar.upload_title.uploading',
      });
    }
