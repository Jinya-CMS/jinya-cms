        ...
        <div class="cosmo-menu-bar">
            ...
            <nav class="cosmo-menu-bar__menu-collection" data-stage="front">
                ...
                <div class="cosmo-menu-bar__sub-menu">
                    ...
                    <a href="#back/maintenance/php-info" data-section="maintenance" data-stage="back" hidden
                       data-page="php-info" class="cosmo-menu-bar__sub-item">
                        ${localize({ key: 'maintenance.menu.php_info' })}
                    </a>
                    <a href="#back/database/mysql-info" data-section="database" data-stage="back" hidden
