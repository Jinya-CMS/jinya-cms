...
use App\Web\Controllers\Menu\Items\CreateMenuItemByMenuItemAction;
...
class CreateMenuItemByMenuItemActionTest extends DatabaseAwareTestCase
{
    ...
    public function test__invokeWithArtist(): void
    {
        ...
        $request = $request->withParsedBody(
            [
                'route' => 'test',
                'artist' => CurrentUser::$currentUser->id,
                'title' => Uuid::uuid(),
                'position' => 0,
                'highlighted' => true
            ]
        ...
        $result = $action($request, $response, ['menuItemId' => $menu->id]);
    ...
    public function test__invokeWithArtistNotFound(): void
    {
        ...
        $request = new ServerRequest('', '');
        $request = $request->withParsedBody(
            ['route' => 'test', 'artist' => -1, 'title' => Uuid::uuid(), 'position' => 0, 'highlighted' => true]
        );
        $response = new Response();
        $action = new CreateMenuItemByMenuItemAction();
        $action($request, $response, ['menuItemId' => $menu->id]);
    }
    ...
    public function test__invokeWithForm(): void
    {
        ...
        $request = new ServerRequest('', '');
        $request = $request->withParsedBody(
            ['route' => 'test', 'form' => $form->id, 'title' => Uuid::uuid(), 'position' => 0, 'highlighted' => true]
        );
        $response = new Response();
        $action = new CreateMenuItemByMenuItemAction();
        $result = $action($request, $response, ['menuItemId' => $menu->id]);
    ...
    public function test__invokeWithFormNotFound(): void
    {
        ...
        $request = new ServerRequest('', '');
        $request = $request->withParsedBody(
            ['route' => 'test', 'form' => -1, 'title' => Uuid::uuid(), 'position' => 0, 'highlighted' => true]
        );
        $response = new Response();
        $action = new CreateMenuItemByMenuItemAction();
        $action($request, $response, ['menuItemId' => $menu->id]);
    ...
    public function test__invokeWithPage(): void
    {
        ...
        $request = new ServerRequest('', '');
        $request = $request->withParsedBody(
            ['route' => 'test', 'page' => $page->id, 'title' => Uuid::uuid(), 'position' => 0, 'highlighted' => true]
        );
        $response = new Response();
        $action = new CreateMenuItemByMenuItemAction();
        $result = $action($request, $response, ['menuItemId' => $menu->id]);
    ...
    public function test__invokeWithPageNotFound(): void
    {
        ...
        $request = new ServerRequest('', '');
        $request = $request->withParsedBody(
            ['route' => 'test', 'page' => -1, 'title' => Uuid::uuid(), 'position' => 0, 'highlighted' => true]
        );
        $response = new Response();
        $action = new CreateMenuItemByMenuItemAction();
        $action($request, $response, ['menuItemId' => $menu->id]);
    ...
    public function test__invokeWithSegmentPageNotFound(): void
    {
        ...
        $request = new ServerRequest('', '');
        $request = $request->withParsedBody(
            ['route' => 'test', 'segmentPage' => -1, 'title' => Uuid::uuid(), 'position' => 0, 'highlighted' => true]
        );
        $response = new Response();
        $action = new CreateMenuItemByMenuItemAction();
        $action($request, $response, ['menuItemId' => $menu->id]);
    ...
    public function test__invokeWithGalleryNotFound(): void
    {
        ...
        $request = new ServerRequest('', '');
        $request = $request->withParsedBody(
            ['route' => 'test', 'gallery' => -1, 'title' => Uuid::uuid(), 'position' => 0, 'highlighted' => true]
        );
        $response = new Response();
        $action = new CreateMenuItemByMenuItemAction();
        $action($request, $response, ['menuItemId' => $menu->id]);
    ...
    public function test__invokeWithCategoryNotFound(): void
    {
        ...
        $request = new ServerRequest('', '');
        $request = $request->withParsedBody(
            ['route' => 'test', 'category' => -1, 'title' => Uuid::uuid(), 'position' => 0, 'highlighted' => true]
        );
        $response = new Response();
        $action = new CreateMenuItemByMenuItemAction();
        $action($request, $response, ['menuItemId' => $menu->id]);
    ...
    public function test__invokeWithBlogHomePage(): void
    {
        ...
        $request = new ServerRequest('', '');
        $request = $request->withParsedBody(
            ['route' => 'test', 'blogHomePage' => true, 'title' => Uuid::uuid(), 'position' => 0, 'highlighted' => true]
        );
        $response = new Response();
        $action = new CreateMenuItemByMenuItemAction();
        $result = $action($request, $response, ['menuItemId' => $menu->id]);
