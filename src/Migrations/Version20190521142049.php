...
final class Version20190521142049 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE theme_menu ADD CONSTRAINT FK_37C2CEAE7675842B FOREIGN KEY (theme_id) REFERENCES theme (id)');
        $this->addSql('ALTER TABLE theme_menu ADD CONSTRAINT FK_37C2CEAED45BC22E FOREIGN KEY (menu_id) REFERENCES menu (id)');
        $this->addSql('ALTER TABLE theme_page ADD CONSTRAINT FK_5ECD421DDABBC69D FOREIGN KEY (theme_id) REFERENCES theme (id)');
        $this->addSql('ALTER TABLE theme_page ADD CONSTRAINT FK_5ECD421D6671BEF3 FOREIGN KEY (page_id) REFERENCES form (id)');
        $this->addSql('ALTER TABLE theme_form ADD CONSTRAINT FK_184F0972EB1E44F9 FOREIGN KEY (theme_id) REFERENCES theme (id)');
        $this->addSql('ALTER TABLE theme_form ADD CONSTRAINT FK_184F0972EB1E44FA FOREIGN KEY (form_id) REFERENCES form (id)');
        $this->addSql('ALTER TABLE theme_art_gallery ADD CONSTRAINT FK_1B446A499D8D9BFA FOREIGN KEY (theme_id) REFERENCES theme (id)');
        ...
        $this->addSql('ALTER TABLE theme_video_gallery ADD CONSTRAINT FK_A1E024ADCEF55CAC FOREIGN KEY (theme_id) REFERENCES theme (id)');
        ...
        $this->addSql('ALTER TABLE theme_artwork ADD CONSTRAINT FK_D17CC055C70B073C FOREIGN KEY (theme_id) REFERENCES theme (id)');
        $this->addSql('ALTER TABLE theme_artwork ADD CONSTRAINT FK_D17CC055C3853658 FOREIGN KEY (artwork_id) REFERENCES artwork (id)');

        $themes = $this->connection->fetchAll('SELECT id, primary_menu_id, secondary_menu_id, footer_menu_id FROM theme');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE theme_form');
        $this->addSql('DROP TABLE theme_art_gallery');
        $this->addSql('DROP TABLE theme_video_gallery');
        $this->addSql('DROP TABLE theme_artwork');
        $this->addSql('ALTER TABLE art_gallery DROP FOREIGN KEY FK_F36F794661220EA6');
        $this->addSql('ALTER TABLE art_gallery DROP FOREIGN KEY FK_F36F7946896DBBDE');
        $this->addSql('DROP INDEX idx_f36f7946896dbbde ON art_gallery');
        $this->addSql('CREATE INDEX IDX_472B783A896DBBDE ON art_gallery (updated_by_id)');
        $this->addSql('DROP INDEX uniq_f36f7946989d9b62 ON art_gallery');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_472B783A989D9B62 ON art_gallery (slug)');
        $this->addSql('DROP INDEX idx_f36f794661220ea6 ON art_gallery');
        $this->addSql('CREATE INDEX IDX_472B783A61220EA6 ON art_gallery (creator_id)');
        $this->addSql('DROP INDEX uniq_f36f79465e237e06 ON art_gallery');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_472B783A5E237E06 ON art_gallery (name)');
        $this->addSql('ALTER TABLE art_gallery ADD CONSTRAINT FK_F36F794661220EA6 FOREIGN KEY (creator_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE art_gallery ADD CONSTRAINT FK_F36F7946896DBBDE FOREIGN KEY (updated_by_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE art_gallery_label DROP FOREIGN KEY FK_7D9BFD6733B92F39');
        $this->addSql('DROP INDEX idx_7d9bfd6733b92f39 ON art_gallery_label');
        $this->addSql('CREATE INDEX IDX_EA3A80CB33B92F39 ON art_gallery_label (label_id)');
        $this->addSql('ALTER TABLE art_gallery_label ADD CONSTRAINT FK_7D9BFD6733B92F39 FOREIGN KEY (label_id) REFERENCES `label` (id) ON DELETE CASCADE');
        $this->addSql('DROP INDEX idx_form_item_position_form ON form_item');
        ...
        $this->addSql('ALTER TABLE users CHANGE about_me about_me LONGTEXT DEFAULT NULL COLLATE utf8_unicode_ci');
        $this->addSql('ALTER TABLE video CHANGE history history LONGTEXT NOT NULL COLLATE utf8_unicode_ci');
        $this->addSql('ALTER TABLE video_gallery CHANGE history history LONGTEXT NOT NULL COLLATE utf8_unicode_ci');
