...
final class Version20190813194535 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message ADD subject VARCHAR(255) NOT NULL, ADD content LONGTEXT NOT NULL, ADD from_address VARCHAR(255) NOT NULL, ADD send_at DATETIME NOT NULL, DROP data');
    }
