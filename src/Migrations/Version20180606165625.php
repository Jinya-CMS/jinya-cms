...
final class Version20180606165625 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE video (id INT AUTO_INCREMENT NOT NULL, creator_id INT DEFAULT NULL, updated_by_id INT DEFAULT NULL, history JSON NOT NULL, created_at DATETIME NOT NULL, last_updated_at DATETIME NOT NULL, description LONGTEXT NOT NULL, video VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_7CC7DA2C989D9B62 (slug), UNIQUE INDEX UNIQ_7CC7DA2C5E237E06 (name), INDEX IDX_7CC7DA2C61220EA6 (creator_id), INDEX IDX_7CC7DA2C896DBBDE (updated_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
