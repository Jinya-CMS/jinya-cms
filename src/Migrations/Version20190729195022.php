...
final class Version20190729195022 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE theme_segment_page ADD CONSTRAINT FK_5BFE07FF59027487 FOREIGN KEY (theme_id) REFERENCES theme (id)');
        $this->addSql('ALTER TABLE theme_segment_page ADD CONSTRAINT FK_5BFE07FF533F2206 FOREIGN KEY (segment_page_id) REFERENCES segment_page (id)');
        $this->addSql('ALTER TABLE form_item ADD spam_filter LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json_array)\'');
        $this->addSql('UPDATE form_item SET spam_filter = \'\' WHERE id > 0');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE theme_segment_page');
    }
}
