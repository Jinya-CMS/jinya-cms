...
final class Version20190529171232 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE segment_page ADD CONSTRAINT FK_CBA9317D61220EA6 FOREIGN KEY (creator_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE segment_page ADD CONSTRAINT FK_CBA9317D896DBBDE FOREIGN KEY (updated_by_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE segment ADD CONSTRAINT FK_1881F565C4663E4 FOREIGN KEY (page_id) REFERENCES segment_page (id)');
        $this->addSql('ALTER TABLE segment ADD CONSTRAINT FK_1881F565DB8FFA4 FOREIGN KEY (artwork_id) REFERENCES artwork (id)');
        $this->addSql('ALTER TABLE segment ADD CONSTRAINT FK_1881F5655FF69B7D FOREIGN KEY (form_id) REFERENCES form (id)');
        $this->addSql('ALTER TABLE segment ADD CONSTRAINT FK_1881F56529C1004E FOREIGN KEY (video_id) REFERENCES video (id)');
        $this->addSql('ALTER TABLE segment ADD CONSTRAINT FK_1881F5658E06FC7F FOREIGN KEY (youtube_video_id) REFERENCES youtube_video (id)');
        $this->addSql('ALTER TABLE segment ADD CONSTRAINT FK_1881F56531A68AC7 FOREIGN KEY (art_gallery_id) REFERENCES art_gallery (id)');
        $this->addSql('ALTER TABLE segment ADD CONSTRAINT FK_1881F5658440B739 FOREIGN KEY (video_gallery_id) REFERENCES art_gallery (id)');
    }
