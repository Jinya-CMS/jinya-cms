...
class ModernPage extends LoggingEntity
{
    #[Id]
    ...
    {
        $this->logger->debug(
            'Get modern page sections',
            ['modernPageId' => $this->id]
        );
    ...
    {
        $this->logger->debug('Replace modern page sections', ['modernPageId' => $this->id]);
        $pdo = self::getPdo();
        ...
        try {
            ...
            $this->logger->debug('Delete old sections', ['modernPageId' => $this->id]);
            self::executeQuery($query);
            $this->logger->debug('Insert new sections', ['modernPageId' => $this->id]);
            ...
            $pdo->rollBack();
            $this->logger->error('Failed to replace sections', ['modernPageId' => $this->id, 'exception' => $ex]);
            throw $ex;
        }
    }
}
