...
class Folder extends LoggingEntity
{
    #[Id]
    ...
    {
        $this->logger->debug('Get all files for folder', ['folderId' => $this->id]);
    ...
    {
        $this->logger->debug('Get all folders for folder', ['folderId' => $this->id]);
