...
class Artist extends LoggingEntity
{
    #[Id]
    ...
    public static function findByEmail(string $email): ?Artist
    {
        ...
        $logger->debug('Find artist by email address');
    ...
    {
        $this->logger->info('Change user password', ['artistId' => $this->id]);
        if ($this->validatePassword($oldPassword)) {
            $this->setPassword($password);
            $this->update();

            $this->logger->info('Clear old api keys', ['artistId' => $this->id]);
    ...
    public static function countAdmins(): int
    {
        ...
        $logger->debug('Count admin users');
    ...
    {
        $this->logger->info('Register failed login attempt', ['artistId' => $this->id]);
    ...
    {
        $this->logger->info('Unlock user account', ['artistId' => $this->id]);
    ...
    {
        $this->logger->info('Set TOTP secret', ['artistId' => $this->id]);
        $otp = TOTP::generate();
    ...
    public function activateOtphp(string $code): bool
    {
        if ($this->totpSecret !== null && $this->totpSecret !== "") {
            ...
            if ($otp->verify($code)) {
                $this->logger->info('Activate totp', ['artistId' => $this->id]);
    ...
    {
        $this->logger->info('Verify totp', ['artistId' => $this->id]);
