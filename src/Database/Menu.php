...
class Menu extends LoggingEntity
{
    #[Id]
    ...
    {
        $this->logger->debug('Replace items in menu', ['menuId' => $this->id]);
        $pdo = self::getPdo();
        ...
        try {
            ...
            $this->logger->debug('Clear old items of menu', ['menuId' => $this->id]);
            ...
            $this->logger->debug('Insert new items into menu', ['menuId' => $this->id]);
            $pdo->commit();
        } catch (PDOException $ex) {
            $pdo->rollBack();
            $this->logger->error('Failed to replace menu items', ['menuId' => $this->id, 'exception' => $ex]);
            throw $ex;
        }
    }
    ...
    {
        $this->logger->debug(
            'Create menu items in menu item',
            [
                'parentId' => $parentId,
