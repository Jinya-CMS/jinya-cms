...
return true if the links are set and false if not.
...
links are set and false if not.
...
if the links are set and false if not.
...
true if the links are set and false if not.
