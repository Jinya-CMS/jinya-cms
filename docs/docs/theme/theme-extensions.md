...
This extension automatically creates the necessary value for the srcset attribute of img tags. The srcset functions takes
...
This extension gives you a simple way to generate a variety of source tags for a given file. The extension takes a `File`
